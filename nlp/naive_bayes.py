# AUTOGENERATED! DO NOT EDIT! File to edit: ../1_3_Naive_Bayes.ipynb.
...
def clean_review(review: str # The review to be cleaned.
    ...
    stopwords = ['and', 'the', 'is', 'in', 'that', 'those', 'there', 'of', 
                 'to', 'by', 'an', 'i', 'me', 'i', 'you', 'her', 'he']
...
def run_naive_bayes(train_file, test_file) -> NaiveBayesSentimentClassifier:
    '''
...
def run_test_file(test_file) -> NaiveBayesSentimentClassifier:
    '''
